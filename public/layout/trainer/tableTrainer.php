  ...
  <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-cyan-50 rounded-none bg-clip-border">
    <div class="flex items-center justify-between gap-8 mb-8">
      ...
      <div class="flex flex-col gap-2 shrink-0 sm:flex-row">
        ...
        <a class="flex select-none items-center gap-3 rounded-lg bg--900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase bg-cyan-900 text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-cyan-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" href="./trainerAdd.php" type="button">
            ...
            <tr>
              ...
              <td class="p-4 border-b border-cyan-900 ">
                <div class="flex items-center">
                  ...
                  <a href="" class="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
