  ...
  <nav class="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
    <div class="relative block w-full">
      <div role="button" class="flex items-center w-full p-0 leading-tight transition-all rounded-lg outline-none bg-blue-gray-50/50 text-start text-blue-gray-700 hover:bg-cyan-100 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900">
        <button id="dashboard" type="button" class="flex items-center justify-between w-full p-3 font-sans text-xl antialiased font-semibold leading-snug text-left transition-colors bg-cyan-900 border-b-0 border-b-blue-gray-100 text-blue-gray-900 hover:text-blue-gray-900">
          ...
          <p class="block mr-auto font-sans text-base antialiased font-normal leading-relaxed text-white">
            Dashboard
          </p>
        </button>
      </div>
      ...
      <div id="members" class="hidden overflow-hidden">
        <div class="block w-full py-1 font-sans text-sm antialiased font-light leading-normal text-gray-700">
          <nav class="flex min-w-[240px] flex-col gap-1 p-0 font-sans text-base font-normal text-blue-gray-700">
            <div role="button" class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none ms-9 text-start hover:bg-cyan-100 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-cyan-100 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-cyan-100 active:bg-opacity-80 active:text-blue-gray-900" id="memberList">
              Member List
            </div>
