...
<div
  class="relative flex flex-col w-full h-full max-w-4xl p-4 text-gray-700 bg-white shadow-xl rounded-xl bg-clip-border shadow-blue-gray-900/5"
>
<div class="">
    ...
    <div class="flex flex-wrap items-center justify-center h-full gap-8 mt-10">
        ...
        <input placeholder="ID" name ="idMember"
    ...
    <div class="flex justify-center w-full mt-10">
        <div class="flex justify-end w-full max-w-lg ">
            ...
            <button class="w-32 py-2 text-2xl font-semibold text-white bg-green-400 rounded-xl">Update</button>
        </div>
