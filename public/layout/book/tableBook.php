...
$query = "SELECT m.name, s.className,b.bookingId, b.bookingDate, m.phone, b.status FROM gym_booking b JOIN member m ON b.memberId = m.idMember JOIN gym_class_schedule s ON b.classId = s.classId;";
  ...
  <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-cyan-50 rounded-none bg-clip-border">
    <div class="flex items-center justify-between gap-8 mb-8">
      ...
      <div class="flex flex-col gap-2 shrink-0 sm:flex-row">
        ...
        <a class="flex select-none items-center gap-3 rounded-lg bg-cyan-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" href="./trainerAdd.php" type="button">
              ...
              <td class="p-4 border-b border-blue-gray-50">
                <div class="flex items-center gap-3">
                  <div>
                    ...
                    <?php endif; ?>
                  </div> <a href="crud/deleteBookProses.php?id=<?= $row["bookingId"] ?>" class="" type="button">
