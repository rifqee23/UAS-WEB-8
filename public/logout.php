...
if (isset($_SESSION['user'])) {
    ...
    echo 'Logout berhasil. Klik <a href="http://localhost/UAS-WEB-8/public/logout.php">di sini</a> untuk login kembali.';
    echo '<br>Anda akan dialihkan ke halaman login dalam 3 detik.';
    echo '<script type="text/javascript">setTimeout(function() { window.location.href = "http://localhost/UAS-WEB-8/public/login.php"; }, 3000);</script>';
} else {
    // Variabel session salah, user tidak seharusnya ada di halaman ini. Kembalikan ke login
    echo '<script type="text/javascript">window.location.href = "http://localhost/UAS-WEB-8/public/login.php";</script>';
